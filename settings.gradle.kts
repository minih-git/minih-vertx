...
//            library("cglib", "cglib:cglib:3.3.0")
            ...
            library("minih-mysql", "cn.minih", "minih-database").versionRef("minih-vertx")

            library("rocketmq", "org.apache.rocketmq:rocketmq-client-java-noshade:5.0.5")

            library("onnxruntime", "com.microsoft.onnxruntime:onnxruntime:1.16.3")
            library("hnswlib", "com.github.jelmerk:hnswlib-core:1.1.0")
...
include("minih-cache")
include("minih-semantic-registry")
include("minih-ai-gateway")
include("minih-gateway-service")
include("minih-system-service")
include("minih-weather-service")