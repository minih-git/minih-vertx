<template>
  <div class="wrapper input-wrapper">
    ...
    <div class="input-con">
      <input ref="accountRef" v-model="formData.username" class="input" placeholder="账号" type="text">
    </div>
  </div>
  <div class="wrapper input-wrapper">
    <div class="input-icon">
    ...
    <div class="input-con">
      <input ref="pwdRef" v-model="formData.password" :type="showPwd?'password':'text'" class="input" placeholder="密码"
